...
/**
 * Serve the files from the tool_dravek file areas
 * @param $course
 * @param $cm
 * @param $context
 * @param $filearea
 ...
 */
function tool_dravek_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $fs = get_file_storage();
    $file = $fs->get_file($context->id, 'tool_dravek', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
